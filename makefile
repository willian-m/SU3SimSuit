...
OBJ_WILSON_LOOP_CORRELATION=$(BIN)/types_params.o $(BIN)/ziggurat.o $(BIN)/math.o $(BIN)/IO.o $(BIN)/lattice.o $(BIN)/objects.o
wilson_loop_correlation.run: dir $(OBJ_WILSON_LOOP_CORRELATION) $(SRC)/wilson_loop_correlation.f90
	$(FC) $(FFLAGS) -I$(BIN) $(OBJ_WILSON_LOOP_CORRELATION) $(SRC)/wilson_loop_correlation.f90 -o $(BIN)/$@
